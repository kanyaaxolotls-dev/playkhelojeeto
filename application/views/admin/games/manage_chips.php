          ...
          <table class="display table table-bordered" id="hidden-table-info">
            ...
            <tbody>
              ...
              <tr class="gradeX">
                ...
                <td><?= $chip->date; ?></td>
                <td>
                  <a class="btn btn-sm btn-primary" href="<?= base_url('backend/games/edit_chips/'.$chip->id) ?>">Edit</a>
                  <a class="btn btn-sm btn-danger" href="<?= base_url('backend/games/delete_chips/'.$chip->id) ?>">Delete</a>
                </td>
              </tr>
              <?php } ?>
            </tbody>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add New Chips</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="<?= base_url('backend/games/manage_chips') ?>" method="post" enctype="multipart/form-data">
      <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="exampleInputEmail2" aria-describedby="emailHelp" placeholder="Enter Bonus" name="p_amount" required>
        </div>
        <div class="form-group">
