...
<head>
    ...
    <title>Distributor Panel | <?= $title ?? 'Dashboard' ?></title>
...
<div class="sidebar" id="sidebar">
    <div class="sidebar-header">
        <h3><i class="fas fa-chart-line"></i> Distributor</h3>
        <p><?= $this->session->userdata('distributor_name') ?? 'Distributor' ?></p>
    </div>
...
<div class="main-content" id="mainContent">
    ...
    <div class="top-navbar">
        <div class="welcome-text">
            <h5><i class="fas fa-hand-wave"></i> Welcome back, <?= $this->session->userdata('distributor_name') ?? 'Distributor' ?>!</h5>
            <p><?= date('l, d F Y') ?></p>
        </div>
        <div class="d-flex align-items-center gap-3">
            <div class="wallet-box">
                <small><i class="fas fa-wallet"></i> Wallet Balance</small>
                <h6>₹ <?= number_format($this->session->userdata('distributor_wallet') ?? 0, 2) ?></h6>
            </div>
            <div class="user-dropdown dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                    <li><a class="dropdown-item" href="<?= site_url('distributor/profile') ?>"><i class="fas fa-user-circle me-2"></i> Profile</a></li>
                    <li><a class="dropdown-item" href="<?= site_url('distributor/change_password') ?>"><i class="fas fa-key me-2"></i> Change Password</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item text-danger" href="<?= site_url('distributor_login/logout') ?>"><i class="fas fa-sign-out-alt me-2"></i> Logout</a></li>
                </ul>
            </div>
        </div>
    </div>